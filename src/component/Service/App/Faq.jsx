...
const Faq = () => {
  ...
  const faqData = [
    { question: " Native iOS Apps" },
    { question: " Native Android Apps " },
    { question: " Cross-Platform Apps " },
    { question: " Hybrid Apps" },
    { question: " E-commerce Apps" },
    { question: " Social Media Apps" },
    { question: "Gaming Apps" },
    { question: " Health and Fitness Apps" },
  ];
      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">
            Types of Mobile Application  We Offer
          </h2>
        </div>
