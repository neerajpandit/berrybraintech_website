            ...
            <div class="-mx-4 flex flex-wrap justify-between">
              <div class="px-4 my-4 w-full xl:w-3/5">
                ...
                <div>
                  <a
                    href="tel:7905796216"
                    className="mt-20 inline-block px-16 py-6 border-2 border-pink-600 text-lg font-semibold rounded-full bg-transparent hover:bg-pink-600 hover:text-white transition duration-300"
                  >
                    Book a Call
                  </a>
              ...
              <div class="px-4 my-4 w-full sm:w-auto xl:w-2/5">
                <div className="chat chat-start">
                  ...
                  <div className="chat-header">
                    {" "}
                    Client <time className="text-xs opacity-50">
                      12:50
                    </time>{" "}
                  </div>{" "}
                ...
                <div className="chat chat-end">
                  ...
                  <div className="chat-header">
                    {" "}
                    You <time className="text-xs opacity-50">12:51</time>{" "}
                  </div>{" "}
                  <div className="chat-bubble">
                    We blend creativity with technology to deliver unique
                    solutions tailored to your needs!
                  </div>{" "}
                  <div className="chat-footer opacity-50">Seen at 12:51</div>{" "}
                </div>{" "}
                <div className="chat chat-start">
                  {" "}
                  <div className="chat-image avatar">
                ...
                <div className="chat chat-end">
                  ...
                  <div className="chat-header">
                    {" "}
                    You <time className="text-xs opacity-50">12:53</time>{" "}
                  </div>{" "}
                  <div className="chat-bubble">
                    We follow agile methodologies, maintaining clear
                    communication and regular feedback to adapt quickly!
                  </div>{" "}
                  <div className="chat-footer opacity-50">Seen at 12:53</div>{" "}
                </div>{" "}
                <div className="chat chat-start">
                  {" "}
                  <div className="chat-image avatar">
                ...
                <div className="chat chat-end">
                  ...
                  <div className="chat-header">
                    {" "}
                    You <time className="text-xs opacity-50">12:55</time>{" "}
                  </div>{" "}
                  <div className="chat-bubble">
                    Absolutely! We prioritize tasks to ensure timely delivery
                ...
                <div className="chat chat-start">
                  ...
                  <div className="chat-bubble">What is your pricing model?</div>{" "}
                  <div className="chat-footer opacity-50">Delivered</div>{" "}
                </div>{" "}
                <div className="chat chat-end">
                  {" "}
                  ...
                  <div className="chat-header">
                    {" "}
                    You <time className="text-xs opacity-50">12:57</time>{" "}
                  </div>{" "}
                  <div className="chat-bubble">
                    We offer flexible pricing tailored to project scope,
                    ensuring you get the best value!
                  </div>{" "}
                  <div className="chat-footer opacity-50">Seen at 12:57</div>{" "}
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col sm:flex-row items-center justify-between pb-14 border-b border-gray-500 gap-8">
              ...
              <div class="flex items-center gap-4">
                ...
                <a
                  href="https://www.instagram.com/berrybraintech"
              ...
              <div class="w-full lg:max-w-md max-lg:mx-auto ">
                <div className="flex w-full flex-col lg:flex-row items-center">
                  ...
                  <div className="card bg-base-300 rounded-box flex-grow flex flex-col items-center justify-center h-32 lg:h-48 p-4">
                    ...
                    <p className="text-sm">
                      Get your project launched in no time!
                    </p>
            ...
            <div class="flex flex-col-reverse sm:flex-row items-center justify-between gap-5 pt-7">
              <span class="text-sm font-normal text-gray-400">
                <a href="https://www.berrybraintech.com/" class="">
                  ©berrybraintech
                </a>{" "}
